...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getPost: function getPost(id) {
      ...
      fetch("https://apirestful.playgroup.pe/api/admin/press_release_posts/".concat(id), {
        method: "GET",
        headers: {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 1;
              _context.next = 4;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(fetch("https://apirestful.playgroup.pe/api/admin/press_release_posts/".concat(this.post.id), {
                method: "DELETE",
                headers: {
                  "Authorization": "Bearer $2a$12$sSnRcwximdTC1qC16P5SZefAJEr2XnYfWtP4c8pm1bJyyuXvrDX.S"
                }
    ...
    getPosts: function getPosts(pagina, desde) {
      ...
      var url = "https://apirestful.playgroup.pe/api/admin/press_release_posts?page=" + pagina + "&desde=" + desde;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.prev = 8;
              _context3.next = 11;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(fetch("https://apirestful.playgroup.pe/api/admin/press_release_posts", {
                method: "POST",
                headers: {
                  "Authorization": "Bearer $2a$12$sSnRcwximdTC1qC16P5SZefAJEr2XnYfWtP4c8pm1bJyyuXvrDX.S"
                },
