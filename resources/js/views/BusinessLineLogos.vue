        ...
        <div class="header-body">
          <div class="row align-items-center pt-0 pt-md-2 pb-4">
            <div class="col-4 col-md-4">
              <BreadCrumb title="Solución de Problemas" active="Solución de Problemas"></BreadCrumb>
            </div>
            <div class="col-8 col-md-8 text-right">
              ...
              >
                ...
                <span class="btn-inner--text">Nuevo Logo</span>
              </a>
            </div>
          </div>
        </div>
                  ...
                  <div class="row">
                    <div class="col-3">
                      <img
                        ...
                        v-if="service.image"
                        :src="'https://storage.googleapis.com/playgroup-web/img/solutions/'+service.image"
                        :alt="service.image"
                      />
                    </div>
                    <div class="col-9">
...
export default {
  ...
  methods: {
    updateStory() {
      ...
      axios
        .post("business-line-logo/" + this.service.id, fd)
        .then(response => {
    ...
    orderStories(elements) {
      axios
        .put("business-line-logo/order", elements)
        .then(response => {
          this.restorePage();
          Swal.fire({
            title: response.data.title,
    ...
    deleteStoryConfirm() {
      this.requestServer = true;
      axios
        .delete("business-line-logo/" + this.service.id)
        .then(response => {
    ...
    getStory(id) {
      axios
        .get("json/business-line-logo/" + id)
        .then(response => {
