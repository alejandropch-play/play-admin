<template>
  ...
  export default {
    ...
    methods: {
      getPost(id) {
          fetch(`${process.env.PG_LATAM_URL}/api/admin/press_release_posts/${id}`, {
            method: "GET",
            headers: {
      ...
      async deletePostConfirm() {
        ...
        try {
          const res = await fetch(`${process.env.PG_LATAM_URL}/api/admin/press_release_posts/${this.post.id}`, {
          method: "DELETE",
          headers: {
              "Authorization": "Bearer $2a$12$sSnRcwximdTC1qC16P5SZefAJEr2XnYfWtP4c8pm1bJyyuXvrDX.S"
            },
      ...
      getPosts(pagina, desde, search = null) {
        ...
        let url = `${process.env.PG_LATAM_URL}/api/admin/press_release_posts?page=` + pagina + "&desde=" + desde;
        if (search) {
...
/*
      ...
      async createPost() {
        ...
        try {
          const res = await fetch(`${process.env.PG_LATAM_URL}/api/admin/press_release_posts`, {
          method: "POST",
          headers: {
              "Authorization": "Bearer $2a$12$sSnRcwximdTC1qC16P5SZefAJEr2XnYfWtP4c8pm1bJyyuXvrDX.S"
            },
