...
var render = function render() {
  ...
  return _c("div", [_c("div", {
  ...
  }, [_vm._v("Nombre")]), _vm._v(" "), _c("small", {
    staticClass: "mb-2 d-block text-muted"
  }, [_vm._v("Tamaño Recomendado: Alto máximo 25px")]), _vm._v(" "), _c("file-upload", {
    ref: "ref_images",
    staticClass: "d-none",
    attrs: {
  ...
  }, [_vm._v("Posición - Puesto")]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.element, "position", $event.target.value);
      }
    }
  }), _vm._v(" "), _vm.errors && _vm.errors.position ? _c("label", {
    staticClass: "mt-2 text-danger text-sm",
    attrs: {
      "for": "id_position"
    }
