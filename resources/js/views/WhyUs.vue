  ...
  <div>
        ...
        <div class="header-body">
          <div class="row align-items-center pt-0 pt-md-2 pb-4">
            <div class="col-6 col-md-7">
              <BreadCrumb title="Sobre Nosotros" active="Sobre Nosotros"></BreadCrumb>
            </div>
            ...
            <div class="col-6 col-md-5 text-right">
              ...
              >
                ...
                <span class="btn-inner--text">Nuevo Información de Nosotros</span>
              </a>
            </div>
          </div>
        </div>
    ...
    <div class="container-fluid mt--6">
      ...
      <div class="card shadow mb-4" v-if="newBlock">
        <div class="card-header border-0">
          <h2 class="mb-0 text-uppercase text-primary">Crear Sobre Nosotros</h2>
        </div>
        <div class="card-body">
      ...
      <div class="card shadow" v-if="editBlock">
        <div class="card-header bg-white border-0">
          <h2 class="mb-0 text-uppercase text-primary">Actualizar Sobre Nosotros</h2>
        </div>
        <div class="card-body">
    ...
    <b-modal centered ref="modal-delete">
      <template slot="modal-title">
        <h2 class="mb-0 text-uppercase text-primary">Eliminar Sobre Nosotros</h2>
      </template>
      <p class="mb-0">Esta seguro que desea eliminar este elemento? </p>
...
export default {
  ...
  methods: {
    ...
    updateElement() {
      ...
      axios
        .post("why-us/" + this.element.id, fd)
        .then(response => {
