(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["js/applicants~js/category~js/chatbot-messages~js/complaints_book~js/contacts~js/posts~js/press_relea~f88d362d"],{
                  ...
                  _c("div", { staticClass: "col-6" }, [
                    _c(
                      ...
                      [
                        ...
                        _vm._v(" "),
                        _vm.elementos && _vm.elementos.length
                          ? _c(
                              "li",
                              {
                                staticClass: "page-item mx-2",
                                class: [
                                  _vm.pageActive == _vm.pagina_actual
                                    ? "active disabled"
                                    : ""
                                ]
                              },
                              [
                                _c(
                                  "select",
                                  {
                                    ...
                                    staticClass:
                                      "form-control bg-white px-2 py-0",
