...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    updateStory: function updateStory() {
      ...
      axios.post("why-us/" + this.service.id, fd).then(function (response) {
    ...
    deleteStoryConfirm: function deleteStoryConfirm() {
      var _this5 = this;
      this.requestServer = true;
      axios["delete"]("why-us/" + this.service.id).then(function (response) {
...
var render = function render() {
  ...
  }, [_vm._v("Nueva Porque Nosotros")])]) : _vm._e()])])])])]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v("Eliminar Porque Nosotros")])]), _vm._v(" "), _c("p", {
    staticClass: "mb-0"
...
var staticRenderFns = [function () {
  ...
  return _c("div", {
    ...
    staticClass: "mb-0 text-uppercase text-primary"
  }, [_vm._v("Actualizar Porque Nosotros")])]);
}, function () {
  var _vm = this,
    _c = _vm._self._c;
  return _c("div", {
